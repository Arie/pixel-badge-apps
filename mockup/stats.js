...
(function (global) {
  ...
  const STATS = [
    ...
    { id: 'HW1',  label: 'HW1',  kind: 'battery', powerMax: MAX.HW_POWER,  sampleSoc: 78, samplePower: 250 },
    { id: 'HW2',  label: 'HW2',  kind: 'battery', powerMax: MAX.HW_POWER,  sampleSoc: 64, samplePower: -180 },
    { id: 'ZEN',  label: 'ZEN',  kind: 'battery', powerMax: MAX.ZEN_POWER, sampleSoc: 41, samplePower: 600 }
  ];
  ...
  global.EnergyConfig = { COLORS, MAX, MODES, STATS, value, colorOf, socColor, powerColor, isSigned, fmt, fmtPower, fmtBat };
})(window);
